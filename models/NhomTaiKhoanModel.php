...
class NhomTaiKhoanModel extends MyModel
{
    public $id;
    public $ten_nhom;
    public $tb_name="tb_nhom_user";
    ...
    public function SaveNew($params = null){
        ...
        $sqlInsert = "INSERT INTO $this->tb_name(ten_nhom)
    ...
    public function SaveUpdate(){
        ...
        $sqlUpdate = "Update $this->tb_name SET ten_nhom = '$this->ten_nhom'
