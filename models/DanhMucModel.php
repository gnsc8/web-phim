...
class DanhMucModel extends MyModel
{
    public $id;
    public $ten_danh_muc;
    public $tb_name="tb_danh_muc";
    ...
    public function SaveNew($params = null){
        ...
        $sqlInsert = "INSERT INTO $this->tb_name(ten_danh_muc)
          VALUES ('$this->ten_danh_muc')";
    ...
    public function SaveUpdate(){
        ...
        $sqlUpdate = "Update $this->tb_name SET ten_danh_muc = '$this->ten_danh_muc'
                    WHERE id = $this->id
                    ";
