...
class ChucNangModel extends MyModel
{
    public $id;
    public $ten_chuc_nang;
    public $link;
    public $tb_name='tb_chuc_nang';
    public function getList($params = null){

        $sql = "SELECT * FROM tb_chuc_nang ORDER  BY id DESC ";
    ...
    public function SaveNew($params = null){
        ...
        $sqlInsert = "INSERT INTO $this->tb_name(ten_chuc_nang,link)
          VALUES ('$this->ten_chuc_nang','$this->link')";
    ...
    public function SaveUpdate(){
        ...
        $sqlUpdate = "Update $this->tb_name SET ten_chuc_nang = '$this->ten_chuc_nang',link='$this->link'
