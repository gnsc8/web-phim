...
class KhuyenMaiModel extends MyModel
{
    public $id;
    public $noi_dung;
    public $id_tai_khoan;
    ...
    public $tb_name="tb_khuyen_mai";

    public function getList($params = null){

        $sql = "SELECT * FROM tb_khuyen_mai ORDER  BY id DESC ";
    ...
    public function SaveNew($params = null){
        ...
        $sqlInsert = "INSERT INTO $this->tb_name(noi_dung,id_tai_khoan,ngay_them)
          VALUES ('$this->noi_dung',$this->id_tai_khoan,'$this->ngay_them')";
    ...
    public function SaveUpdate(){
        ...
        $sqlUpdate = "Update $this->tb_name SET noi_dung = '$this->noi_dung',
